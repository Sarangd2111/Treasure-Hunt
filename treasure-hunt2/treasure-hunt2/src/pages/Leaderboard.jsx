...
const Leaderboard = () => {
  ...
  const getLeader1 = async () => {
    try {
      const response1 = await fetch(`${BASE_URL}/leaderboard1`  || `${process.env.PORT}/leaderboard1`);
  ...
  const getLeader2 = async()=>{
    try{
        const response2 = await fetch(`${BASE_URL}/leaderboard2`  || `${process.env.PORT}/leaderboard2`);
  ...
  const getLeader3 = async()=>{
    try{
        const response3 = await fetch(`${BASE_URL}/leaderboard3`  || `${process.env.PORT}/leaderboard3`);
  ...
  const getLeader4 = async()=>{
    try{
        const response4 = await fetch(`${BASE_URL}/leaderboard4`  || `${process.env.PORT}/leaderboard4`);
  ...
  const getLeader5 = async()=>{
    try{
        const response5 = await fetch(`${BASE_URL}/leaderboard5`  || `${process.env.PORT}/leaderboard5`);
  ...
  const getLeader6 = async()=>{
    try{
        const response6 = await fetch(`${BASE_URL}/leaderboard6` || `${process.env.PORT}/leaderboard6`);
